...
class LookUpManager
{
    ...
    public function __construct(GraphManager $gm, EntityManager $em, TokensManager $tm, LookUpFullContact $fullContact, LookUpPeopleGraph $peopleGraph, EventDispatcher $dispatcher)
