...
class ServicesServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['user.service'] = function (Application $app) {
        ...
        $app['link.service'] = function (Application $app) {
            return new LinkService($app['links.model'], $app['popularity.manager'], $app['users.affinity.model']);
        };

        $app['register.service'] = function (Application $app) {
        ...
        $app['chatMessageNotifications.service'] = function (Application $app) {
        ...
        $app['affinityRecalculations.service'] = function (Application $app) {
        ...
        $app['socialNetwork.service'] = function (Application $app) {
        ...
        $app['emailNotification.service'] = function (Application $app) {
            return new EmailNotifications($app['mailer'], $app['orm.ems']['mysql_brain'], $app['twig']);
        };

        $app['device.service'] = function (Application $app) {
        ...
        $app['recommendator.service'] = function (Application $app) {
        ...
        $app['threads.service'] = function( Application $app) {
        ...
        $app['userAggregator.service'] = function (Application $app) {
        ...
        $app['userStats.service'] = function (Application $app) {
        ...
        $app['validator.service'] = function (Application $app) {
            return new Validator($app['neo4j.graph_manager'], $app['fields']);
        };

        $app['validator.factory'] = function (Application $app) {
        ...
        $app['amqpManager.service'] = function (Application $app) {
            return new AMQPManager($app['amqp']);
        };

        $app['notificationManager.service'] = function (Application $app) {
            return new NotificationManager($app['neo4j.graph_manager']);
        };

        $app['enqueueLinks.service'] = function (Application $app) {
            return new EnqueueLinksService($app['links.model'], $app['amqpManager.service']);
        };

        $app['consistency.service'] = function (Application $app) {
            return new ConsistencyCheckerService($app['neo4j.graph_manager'], $app['dispatcher'], $app['consistency']);
        };

        $app['dispatcher.service'] = function (Application $app) {
            return new EventDispatcher($app['dispatcher']);
        };

        $app['question.service'] = function (Application $app) {
        ...
        $app['metadata.service'] = function (Application $app) {
