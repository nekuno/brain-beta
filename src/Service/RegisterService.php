...
class RegisterService
{
    ...
    public function __construct(UserManager $um, GhostUserManager $gum, TokensModel $tm, ProfileModel $pm, InvitationModel $im, GroupModel $gm, EventDispatcher $dispatcher)
    {
        $this->um = $um;
        $this->gum = $gum;
        $this->tm = $tm;
